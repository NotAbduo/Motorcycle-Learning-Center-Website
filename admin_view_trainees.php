...
<a href="admin_trainee_database.php" class="back-button"><i class="fas fa-arrow-left"></i></a>

<div class="dashboard-container">
    <h1>All Trainees - Admin Panel</h1>
    ...
    <div class="export-buttons">
		...
		<button class="advanced-btn" onclick="window.location.href='check_duplicates.php'">
			<i class="fas fa-cogs"></i>Check Duplicate Names
		</button>
            ...
            <?php if ($result->num_rows > 0): ?>
                ...
                <?php while ($row = $result->fetch_assoc()): ?>
                    <tr>
                        ...
                        <td>
                            <a href="edit_trainee.php?id=<?= $row['id'] ?>">
                                <button><i class="fas fa-edit"></i> Edit</button>
                            </a>
                        </td>
                    </tr>
