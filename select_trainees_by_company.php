...
if (!isset($_SESSION['user_id']) || !isset($_POST['selected_company']) || !isset($_POST['selected_instructors'])) {
...
<div class="dashboard-container">
    ...
    <form id="traineeForm" method="POST" action="submit_multiple_hours_action.php">
